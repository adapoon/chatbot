...
def main():
    ...
    # PATH: Nearest routes
    dispatcher.add_handler(ConversationHandler(
                                entry_points=[MessageHandler(Filters.location, location.start)],
...
def start_command(update: Update, context: CallbackContext):
    context.bot.send_message(chat_id=update.effective_chat.id, text=const.WELCOME, reply_markup=ReplyKeyboardMarkup(keyboard=const.KEYBOARD, resize_keyboard=True))
